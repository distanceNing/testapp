...
func TestCreateObject(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := CreateObject(tt.args.obj); !reflect.DeepEqual(got, tt.want) {
...
func TestUpdateObject(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := UpdateObject(tt.args.cond, tt.args.updateField); !reflect.DeepEqual(got, tt.want) {
...
func TestQueryObjectByPage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := QueryObjectByPage(tt.args.cond, tt.args.objs, tt.args.pageCount, tt.args.pageNum); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("QueryObjectByPage() = %v, want %v", got, tt.want)
			}
			t.Log(tt.args.objs)
		})
	}
...
func TestQueryObjectCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := QueryObjectCount(tt.args.cond, tt.args.count); !reflect.DeepEqual(tt.want, got) || tt.count != *tt.args.count {
