...
func (svc *Service) Login(req *LoginRequest, rsp *common.Rsp) error {
	return svc.loginSvc.Login(req, rsp)
}

func (svc *Service) Register(req *LoginRequest, rsp *common.Rsp) error {
	return svc.loginSvc.Register(req, rsp)
}

func (svc *Service) GetArticle(req *GetArticleReq, rsp *common.Rsp) error {
	return svc.articleMgr.GetArticle(req, rsp)
}

func (svc *Service) CreateArticle(req *CreateArticleReq, rsp *common.Rsp) error {
	return svc.articleMgr.CreateArticle(req, rsp)
}

func (svc *Service) GetChannels(req *CreateArticleReq, rsp *common.Rsp) error {
	return svc.articleMgr.GetChannels(req, rsp)
}

func (svc *Service) SearchArticle(req *GetArticlePageReq, rsp *common.Rsp) error {
	return svc.articleMgr.SearchArticle(req, rsp)
}

func (svc *Service) Upload(req *UploadImageReq, rsp *common.Rsp) error {
	return svc.imageMgr.Upload(req, rsp)
}

func (svc *Service) DeleteArticle(req *DeleteArticleReq, rsp *common.Rsp) error {
	return svc.articleMgr.DeleteArticle(req, rsp)
}

func (svc *Service) UpdateArticle(req *UpdateArticleReq, rsp *common.Rsp) error {
	return svc.articleMgr.UpdateArticle(req, rsp)
}
func (svc *Service) GetImages(req *GetImageReq, rsp *common.Rsp) error {
